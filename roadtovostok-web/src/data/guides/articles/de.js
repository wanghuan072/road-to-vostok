...
export default [
  ...
  <p>TBA (aktive Entwicklung / Early Access)</p>
  <p><strong>Genre</strong></p>
  <p>Hardcore Singleplayer-Survival-Shooter</p>
  <p><strong>Schauplatz</strong></p>
  <p>Postapokalyptische finnisch-russische Grenzregion</p>
...
<li><a href="https://www.youtube.com/embed/QVdZjWBqMH4?start=989&amp;autoplay=1&amp;playsinline=1" target="rtvFishGuideYt">[16:29]</a> — Marktwerte (Hecht, Barsch usw.)</li>
      ...
      <table>
          ...
          <tbody>
              <tr>
                  <td>Hecht (Pike)</td>
                  <td>250 $</td>
                  <td>Quest / Lieferung / hoher Verkauf</td>
              </tr>
              <tr>
                  <td>Barsch (Perch)</td>
                  <td>150 $</td>
    ...
    head: `<script type="application/ld+json">
      {
        ...
        "hasPart": [
          {
            "@type": "Clip",
            "name": "Pistolen-Basics &amp; UI-Mechanik",
            "startOffset": 1,
            "endOffset": 128,
  ...
  <tbody>
  <tr>
  <td data-row="row-01v85e">Waffe</td>
  <td data-row="row-01v85e">Seltenheit</td>
  <td data-row="row-01v85e">Schaden</td>
  <td data-row="row-01v85e">Penetration</td>
  </tr>
  <tr>
  <td data-row="row-t7dalz">Makarov</td>
  <td data-row="row-t7dalz">Common</td>
  <td data-row="row-t7dalz">25</td>
  <td data-row="row-t7dalz">Stufe 1</td>
  </tr>
  <tr>
  <td data-row="row-25km8n">RM-870</td>
  <td data-row="row-25km8n">Uncommon</td>
  <td data-row="row-25km8n">40</td>
  <td data-row="row-25km8n">Stufe 2</td>
  </tr>
  <tr>
  <td data-row="row-oa6ybo">AK-12</td>
  <td data-row="row-oa6ybo">Uncommon</td>
  <td data-row="row-oa6ybo">30</td>
  <td data-row="row-oa6ybo">Stufe 3</td>
  </tr>
  <tr>
  <td data-row="row-qw11rw">MP5SD</td>
  <td data-row="row-qw11rw">Rare</td>
  <td data-row="row-qw11rw">25</td>
  <td data-row="row-qw11rw">Stufe 1</td>
  </tr>
  <tr>
  <td data-row="row-4praxi">SVD</td>
  <td data-row="row-4praxi">Rare</td>
  <td data-row="row-4praxi">50</td>
  <td data-row="row-4praxi">Stufe 4</td>
  </tr>
  <tr>
  <td data-row="row-j2o2ow">KP-31</td>
  <td data-row="row-j2o2ow">Legendary</td>
  <td data-row="row-j2o2ow">25</td>
  <td data-row="row-j2o2ow">Stufe 1</td>
  </tr>
  <tr>
  <td data-row="row-yav5jw">M78</td>
  <td data-row="row-yav5jw">Legendary</td>
  <td data-row="row-yav5jw">50</td>
  <td data-row="row-yav5jw">Stufe 4</td>
  </tr>
  </tbody>
  </table>
  ...
  <h3>RM-870 Schrotflinte nachladen
  </h3>
  <p><img src="/images/guides/guides06-01.webp" alt="RM-870 Flinte: Nachladevorgang" width="50%">
  </p>
  ...
  {
    id: 13,
    title: "Road To Vostok Keys Guide: Keller, Schrank und seltene Locks",
    description: "Finde Keys, Kellerzugang, locked cabinets, Bypass-Risiken und aktuelle Build-Checks.",
    tags: ["road to vostok keys","cellar key","locked cabinet","bunker key"],
    publishDate: "2026-07-06",
    imageUrl: "/images/guides/guides13.webp",
    imageAlt: "road to vostok keys und cabinet guide",
    seo: {
      title: "Road To Vostok Keys und Cabinet Guide",
      description: "Finde Keys, Kellerzugang, locked cabinets, Bypass-Risiken und welche Keys Build-Checks brauchen.",
    ...
    detailsHtml: `
  <p><strong>Schnelle Antwort: Keys sind optionale Zugangswerkzeuge, nicht dein Hauptfortschritt. Der cellar key ist als seltener General-Loot bestaetigt; suche Cabinets, Bodies, Trash Bags und normale Container.</strong></p>
  <p>Plane keine Route um ungepruefte Key-Namen. tunnel, ceiling, bunker, Doctor/Doktor, gym und school Keys brauchen den aktuellen Door- oder Container-Prompt.</p>
  <figure><img src="/images/guides/guides13.webp" alt="road to vostok cellar key route near the village and generalist trader" title="Road To Vostok cellar key route near The Generalist" width="50%"><figcaption>Die cellar key Route startet beim Village-Ansatz. Prompt pruefen, dann erst farmen.</figcaption></figure>
  <h2>Wo Keys in die Progression passen</h2>
  <h3>Key-System kurz erklaert</h3>
  <p>Keys oeffnen Side Rooms, locked containers und Shortcuts. Nutze erst <a href="/guides/road-to-vostok-shelter-locations">Shelter Routen</a>, Food, Hydration, Ammo und Medizin als Basis.</p>
  <table><thead><tr><th>Key oder Lock-Intent</th><th>Bester aktueller Nutzen</th><th>Verifikation</th></tr></thead><tbody><tr><td>cellar key</td><td>Village cellar fuer Loot und Crates oeffnen</td><td>Bestaetigter seltener General-Loot</td></tr><tr><td>Tunnel / ceiling key</td><td>Prompt vor Key-Namen pruefen</td><td>INFERRED; Build pruefen</td></tr><tr><td>bunker key</td><td>Nur nutzen, wenn der Door-Prompt ihn nennt</td><td>Build-abhaengig</td></tr><tr><td>Doctor / Doktor key</td><td>Medizin- oder Named-Room-Zugang</td><td>Prompt pruefen</td></tr><tr><td>Gym / school key</td><td>School- und gimnazium-Checks</td><td>Aktuellen Build pruefen</td></tr></tbody></table>
  ...
  <table><thead><tr><th>Cabinet type</th><th>Was tun</th><th>Common mistake</th></tr></thead><tbody><tr><td>Normal searchable cabinet</td><td>Auf normaler Route looten</td><td>Beim Key-Farm ueberspringen</td></tr><tr><td>Locked office cabinet</td><td>Exakten Prompt und Key pruefen</td><td>Alle Cabinets fuer gleich halten</td></tr><tr><td>Named oder trader-area cabinet</td><td>Container von NPC/vendor trennen</td><td>Scenery als Storage behandeln</td></tr></tbody></table>
  <h3>Generalist cabinet</h3>
  <p>The Generalist ist ein Landmark, keine Garantie. Nutze die <a href="/wiki/npcs/generalist">Generalist NPC page</a>, dann teste den cabinet selbst.</p>
  ...
  <h2>FAQ</h2>
  <h3>Wo ist der cellar key?</h3><p>Als seltener General-Loot in cabinets, bodies, trash bags und normalen Containern.</p><h3>Geht cellar ohne key?</h3><p>Nicht darauf bauen. Stabil ist der cellar key.</p><h3>Sind bunker, Doctor und gym keys bestaetigt?</h3><p>Als Suchintent ja, aber Nutzen haengt vom aktuellen Prompt und Build ab.</p>`,
  }

  ,
  {
    id: 14,
    title: "Road To Vostok Health Guide: Hydration, Regen, Food und Status",
    description: "Pruefe Health-Verlust, Hydration, Wasser, Food, Cooking Tools, hot plate, kilju und Recovery.",
    tags: ["road to vostok health","hydration","water bottle","cooking"],
    publishDate: "2026-07-06",
    imageUrl: "/images/guides/guides14.webp",
    imageAlt: "road to vostok health und hydration guide",
    seo: {
      title: "Road To Vostok Health und Hydration Guide",
      description: "Pruefe Health-Verlust, Hydration, Wasser, Food, Cooking Tools, hot plate, kilju und Status-Recovery.",
    ...
    detailsHtml: `
  <p><strong>Schnelle Antwort: Wenn Health faellt, pruefe nicht nur HP. Check Hydration, Food/Energy, bleeding, fracture, cold/sickness und aktive Status Icons.</strong></p>
  ...
  <h2>Warum Health weiter faellt</h2>
  <h3>Health drain causes</h3>
  <p>Road To Vostok bestraft Status-Ignoranz. Nach Kampf zuerst wound/status pruefen; auf Reisen Hydration, Energy, Cold und Sickness.</p>
  ...
  <h3>Health regen</h3>
  <p>Passive regen nicht als Rettung planen. Food und Medical Items koennen Health geben, aber aktiver Status macht den Gain temporaer.</p>
  <p>Nutze <a href="/getting-started#medical">Medical Basics</a> und <a href="/wiki/core-tasks">core task list</a> fuer klare Trennung.</p>
  ...
  <p>Hot plate, happy stove und cooking unit zuerst auf usable, placeable oder recipe-bound pruefen.</p>
  <p>Cooking braucht Shelter-Logistik. Nutze den <a href="/guides/road-to-vostok-shelter-locations">Shelter Guide</a>.</p>
  <h3>Making kilju</h3>
  <p>Kilju ist build-dependent. Wenn kein Recipe sichtbar ist, als <strong>INFERRED</strong> behandeln.</p>
  <h2>FAQ</h2>
  <h3>Warum faellt meine Health?</h3><p>Status icons, hydration, food/energy, bleeding, fracture, cold und sickness pruefen.</p><h3>Wie fixe ich hydration?</h3><p>Water, juice, soda oder Item mit hydration value trinken.</p><h3>Wie funktionieren cooking und kilju?</h3><p>Nur aktuelle Tooltips nutzen; Requirements koennen wechseln.</p>`,
  },
  {
    id: 15,
    title: "Road To Vostok Shelter Guide: Storage, Saving, Customization und Safe Logout",
    description: "Shelter-Guide fuer Save Flow, sichere Lagerung, Customization, Logout-Risiko, Tent Shelter, School Shelter Checks und Food Freezer.",
    tags: ["Shelter", "Storage", "Saving", "Survival"],
    publishDate: "2026-07-13",
    imageUrl: "/images/guides/guides15.jpg",
    imageAlt: "Road To Vostok shelter storage save guide mit safe logout und freezer storage",
    seo: {
      title: "Road To Vostok Shelter und Save Guide",
      description: "Speichere sicher, lagere Items, plane Shelter-Customization, Logout-Risiko und Food-Freezer-Storage in Road To Vostok.",
      keywords: "road to vostok shelters, save, storage, customization",
    },
    addressBar: "road-to-vostok-shelter-storage-save-guide",
    detailsHtml: `<p><strong>Kurze Antwort:</strong> Shelter sind deine sicheren Reset-Punkte. Speichere dort, lege Task Items ab, trenne Route-Supplies von Stash-Supplies und logge nicht in offenen Kampfzonen aus.</p>
  <figure><img src="/images/guides/guides15.jpg" alt="road to vostok shelter storage save safe logout guide" title="Road To Vostok shelter storage and save guide" width="50%"><figcaption>Save zuerst, wertvolle Items danach einlagern, dann nur mit dem Kit fuer die naechste Route rausgehen.</figcaption></figure>
  <h2>How shelters work</h2>
  <h3>Shelter purpose and safe storage</h3>
  <p>Ein Shelter ist mehr als ein Ruhepunkt. Nutze ihn fuer Save, Storage und Routenplanung. Keys, Task Items, seltene Medicine und Ersatzammo gehoeren in Storage, wenn sie fuer die naechste Route nicht gebraucht werden.</p>
  <p>Fuer Orte nutze den <a href="/guides/road-to-vostok-shelter-locations">Shelter Locations Guide</a> und die <a href="/map/village-map">Village Map</a>.</p>
  <h3>Saving your game</h3>
  <p>Speichere aus einem stabilen Shelter-Zustand: Gefahr pruefen, Items lagern, Shelter- oder Save-Prompt abschliessen. Wenn die aktuelle Version Autosave nutzt, zaehlt erst die abgeschlossene Shelter-Interaktion als sauberer Save.</p>
  <h3>Logging out outside shelter</h3>
  <p>Logout ausserhalb eines Shelters ist Risiko. Behandle ihn nicht wie einen Shelter Save, solange das Spiel es nicht klar bestaetigt.</p>
  <h2>Shelter locations and customization</h2>
  <h3>Tent shelter and shelter map</h3>
  <p>Plane mit Map-Markern, nicht mit Erinnerung. Tent Shelter, Village Cabin, Attic Shelter und School-Fragen muessen in der aktuellen Map geprueft werden.</p>
  <h3>Customizing shelter</h3>
  <p>Customization soll Retrieval-Speed verbessern: Medicine zusammen, Ammo getrennt, Task Items in einen eigenen Bereich. Teste Placement zuerst mit Low-Value Items.</p>
  <h3>Picking up items inside shelter</h3>
  <p>Wenn ein Item auf dem Boden liegt, zaehlt nur der echte Interact-Prompt. Kein Prompt bedeutet meist Deko, falscher Winkel oder blockierter Inventory-State.</p>
  <h2>Food and freezer storage</h2>
  <h3>Is food safe in the cabin freezer?</h3>
  <p>Wenn der Freezer als echter Container oeffnet und Items annimmt, ist er Shelter-Storage. Spoilage-Schutz ist <strong>INFERRED</strong>, bis die aktuelle Version ihn klar zeigt.</p>
  <h2>FAQ</h2>
  <h3>How do you save in Road To Vostok?</h3><p>Zum Shelter gehen, Save- oder Shelter-Interaktion abschliessen und Wertitems vorher lagern.</p>
  <h3>Where can you save items?</h3><p>In bestaetigter Shelter-Storage oder klar nutzbaren Containern. Floor Placement nur mit billigen Items testen.</p>`,
  },
  {
    id: 16,
    title: "Road To Vostok Village Guide: Tasks, Bandits, Boss Spawn, Radio und Loot",
    description: "Village-Guide fuer Route, Map, Tasks, Bandits, Boss-Spawn Checks, Night Behavior, Radio Pins, Cat Task, Doctor Links und Loot.",
    ...
    seo: {
      title: "Road To Vostok Village Tasks und Loot Guide",
      description: "Plane Village-Routen, Tasks, Bandits, Boss-Checks, Radio-Punkte, besten Loot, Cat Task und Doctor Links in Road To Vostok.",
      keywords: "road to vostok village, tasks, bandits, boss spawn, loot",
    },
    addressBar: "road-to-vostok-village-tasks-bandits-loot-guide",
    detailsHtml: `<p><strong>Kurze Antwort:</strong> Village ist ein Task- und Loot-Hub. Starte am Shelter, pruefe Trader und Radio, loote kontrolliert und geh raus, bevor Bandits deine Medicine verbrennen.</p>
  <figure><img src="/images/guides/guides16.jpg" alt="road to vostok village tasks bandits boss spawn radio loot guide" title="Road To Vostok Village tasks and loot guide" width="50%"><figcaption>Village belohnt kurze Routen: Shelter, Trader, Radio, Locked Door, Loot, Exit.</figcaption></figure>
  <h2>Village route and map</h2>
  <h3>Village map basics</h3>
  <p>Nutze die <a href="/map/village-map">Village Map</a>. Die sichere Reihenfolge ist Shelter, Objective, Loot, Exit. Wenn du nach vilage gesucht hast: es ist derselbe Village-Bereich.</p>
  <h3>Village task list</h3>
  <p>Village Tasks verbinden NPC-Routing, Item Recovery und Survival. Fuer Cat Task nutze den <a href="/guides/cat-guide-find-care-shelter-companion">Cat Guide</a>; fuer Doctor Progress die <a href="/wiki/npcs/doctor">Doctor Page</a>.</p>
  <h2>Bandits and boss spawn</h2>
  <h3>How many bandits are in Village?</h3>
  <p>Es gibt keine sichere feste Zahl. Bandit Count haengt von Build, Spawn State und Route Noise ab. Zaehle bestaetigte Kontakte in deinem Run.</p>
  <h3>Boss spawn location</h3>
  <p><strong>INFERRED:</strong> Boss-Spawn Reports sind build-sensitive. Kontrolliere High-Value Buildings und Loot Cluster aus Cover, nicht von der offenen Strasse.</p>
  <h3>Bandit behavior at night</h3>
  <p>Nacht macht Village nicht sicher. Bandits koennen langsam reagieren, aber sie bleiben gefaehrlich, besonders mit Fenster- und Cover-Angles.</p>
