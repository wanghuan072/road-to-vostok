...
`,
  },
  {
    addressBar: 'cat',
    location: {
      title: 'Shelter · Area 05 transfers',
      content:
        'Not a map NPC: the cat lives at your cabin after a rescue chain that crosses Village, School, and Outpost in community reports. Traders on those maps are the Generalist and Doctor — see their articles for stock and tasks.',
    },
    title: 'Cat (companion)',
    role: 'Shelter companion · system feature',
    summary:
      'Shelter pet unlocked through a time-gated rescue loop (often called “Missing Cat” in the community): Outpost bunker / well pickup, large Cat Box, cabin placement, and periodic feeding — not a trader or hostile faction.',
    seo: {
      title: 'Cat companion: shelter pet overview',
      description:
        'Road To Vostok cat companion: shelter pet, Missing Cat style event, Outpost rescue, Cat Box, feeding basics. Short wiki stub; confirm in your build.',
      keywords:
        'Road To Vostok, cat companion, shelter pet, Missing Cat, Outpost, Cat Box, Early Access',
      ogType: 'article',
    },
    detailsHtml: `
<p class="npc-lead">The <strong>cat</strong> is a <strong>shelter companion</strong> — a <strong>system feature</strong>, not a trader or bandit. Developer updates have shown a detailed, voiced cat players can <strong>adopt</strong>; community play reports add <strong>quest-like timing</strong>, a <strong>multi-map rescue</strong>, and <strong>cabin upkeep</strong>.</p>
<p class="npc-see-also">Step-by-step route, prep, and save quirks belong in a <strong>guide article</strong> (planned on this site under <a href="/guides">Guides</a>) so this page stays a short reference.</p>

<h2>Role</h2>
<ul>
  <li>After adoption, the cat is tied to your <strong>cabin / shelter</strong> as a <strong>persistent companion</strong> in reported builds.</li>
  <li>It does not function like <strong>Generalist</strong> or <strong>Doctor</strong> — no barter UI; care is described as <strong>feeding</strong> and <strong>placement</strong> mechanics instead.</li>
</ul>

<h2>Acquisition (summary)</h2>
<ul>
  <li>Community reports tie unlock to a <strong>“Missing Cat”</strong>-style beat after several in-game days, advanced by normal play and <strong>sleep</strong>.</li>
  <li>The rescue usually involves <strong>several map transfers</strong> (commonly <strong>Village → School → Outpost</strong> and back), a <strong>bunker</strong> scene on <strong>Outpost</strong> (well / plank cover / box), and carrying a large <strong>Cat Box</strong> to the cabin.</li>
  <li><strong>Which bunker</strong> spawns the encounter can vary between players and patches — verify in your client.</li>
</ul>

<h2>Shelter behaviour</h2>
<ul>
  <li>Players place the <strong>Cat Box</strong> <strong>inside the cabin</strong>; the box then <strong>opens</strong> after a short wait.</li>
  <li><strong>Feeding</strong> is described as periodic (roughly <strong>~36 in-game hours</strong> in community notes) with foods such as <strong>cat food</strong>, <strong>fish</strong>, and <strong>meat</strong>; stash can live in <strong>cabin storage</strong>, not only your pockets.</li>
  <li><strong>Petting</strong> may be absent depending on build.</li>
</ul>

<h2>See also</h2>
<ul>
  <li><a href="/wiki/npcs/generalist">Generalist</a> · <a href="/wiki/npcs/doctor">Doctor</a> — traders often used during the same transfer chain.</li>
  <li><a href="/wiki/fishing">Fishing</a> — fish as possible feed.</li>
  <li><a href="/map">Map</a> — hubs and exits.</li>
  <li><a href="/guides">Guides</a> — full cat walkthrough when published.</li>
</ul>

<p class="npc-muted">Community-sourced behaviour notes; not official patch text. If anything disagrees with your game, trust the client and first-party posts.</p>
`,
  },
]
